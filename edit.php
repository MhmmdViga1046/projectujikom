...
<head>
    ...
    <title>EDIT BARANG - UKK SMK Madinatul Quran</title>
    <!-- Favicon-->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <input type="hidden" name="id" value="<?php echo $munculkandata['id_barang'];?>">                                
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="kode_barang" value="<?php echo $munculkandata['kode_barang']; ?>">
                                        <label class="form-label">Kode Barang</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control"name="nama_barang" value="<?php echo $munculkandata['nama_barang']; ?>">
                                ...
                                <div class="form-group">
                                    <select class="form-control show-tick" name="jenis_barang"required>
                                        <option value="<?php echo $munculkandata['jenis_barang']; ?>"><?php echo $munculkandata['jenis_barang']; ?>
                                    </option>
                                ...
                                <div class="form-group">
                                    <select class="form-control show-tick" name="satuan"required>
                                        <option value="<?php echo $munculkandata['satuan']; ?>"><?php echo $munculkandata['satuan']; ?> </option>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="stok" value="<?php echo $munculkandata['stok']; ?>">
                                        <label class="form-label">Stok</label>
                                    </div>
                                </div>
                                <button class="btn btn-success waves-effect" type="submit"><i class="material-icons">edit</i><span> EDIT</span></button>
